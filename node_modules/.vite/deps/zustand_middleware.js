...
var devtoolsImpl = (fn, devtoolsOptions = {}) => (set, get, api) => {
	...
	if (!extensionConnector) {
		if ((import.meta.env ? import.meta.env.MODE : void 0) !== "production" && enabled) console.warn("[zustand devtools middleware] Please install/enable Redux devtools extension");
